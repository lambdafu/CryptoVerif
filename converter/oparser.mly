...
|       COLLISION newlist FORALL vartypelist SEMI RETURN LPAREN term RPAREN EQUIVLEFT probaf EQUIVRIGHT RETURN LPAREN term RPAREN DOT 
        { [Collision($2, $4, $8, $11, $15), parse_extent()] }
|       COLLISION newlist RETURN LPAREN term RPAREN EQUIVLEFT probaf EQUIVRIGHT RETURN LPAREN term RPAREN DOT 
        { [Collision($2, [], $5, $8, $12), parse_extent()] }
