...
ocamlfind ocamlopt $CRYPTOKIT -I .. -o server str.cmxa ../base.mli ../base.ml ../crypto.mli ../crypto.ml ssh_crypto.mli ssh_crypto.ml ssh_network.mli ssh_network.ml Letfun.mli Letfun.ml SSH_S.mli SSH_S.ml ssh_server.ml
ocamlfind ocamlopt $CRYPTOKIT -I .. -o client str.cmxa ../base.mli ../base.ml ../crypto.mli ../crypto.ml ssh_crypto.mli ssh_crypto.ml ssh_network.mli ssh_network.ml Letfun.mli Letfun.ml SSH_C.mli SSH_C.ml ssh_client.ml
ocamlfind ocamlopt $CRYPTOKIT -I .. -o keygen str.cmxa ../base.mli ../base.ml ../crypto.mli ../crypto.ml ssh_crypto.mli ssh_crypto.ml ssh_network.mli ssh_network.ml Letfun.mli Letfun.ml SSH_Keygen.mli SSH_Keygen.ml ssh_kgen.ml
