...
let rec simplify_term_w_find cur_array true_facts t =
  ...
  | TestE(t1,t2,t3) ->
      begin
	match t2.t_desc, t3.t_desc with
	| EventAbortE f, EventAbortE f' when f == f' ->
	    t2
	| _ -> 
  ...
  | FindE(l0,t3,find_info) ->
	...
	| EventAbortE f when List.for_all (fun (_,_,_,t2) ->
