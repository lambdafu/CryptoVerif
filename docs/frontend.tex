...
\texttt{size$\textit{min}$\_$\textit{max}$} means that  $2^{\textit{min}} \leq |T| \leq 2^{\textit{max}}$, where $\textit{min}$ and $\textit{max}$ are integers.
...
\item \texttt{large} is equivalent to \texttt{size256\_4611686018427387903}, \texttt{pcoll256}, that is, $|T| \geq 2^{256}$ and $\texttt{Pcoll1rand}(T) \leq 2^{-256}$.
