...
\item $\texttt{expand IND\_CPA\_sym\_enc\_r(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r},
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}\texttt{).}$ is similar to the above,
...
\item $\texttt{expand IND\_CPA\_INT\_CTXT\_sym\_enc\_r(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r},
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pencctxt}\texttt{).}$  is similar to the above,
  with two additional arguments. 
  $\vn{enc\_seed}$ is the type of random coins for encryption, must be \texttt{bounded}.
  $\vn{enc\_r}(\vn{cleartext}, \vn{key}, \vn{enc\_seed}): \vn{ciphertext}$ is the encryption function that takes coins as argument (instead of generating them internally).
...
\item $\texttt{expand AEAD(}\vn{key},
  ...
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pencctxt}\texttt{).}$ defines an
...
\item $\texttt{expand AEAD\_r(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{add\_data}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r},
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pencctxt}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{enc\_seed}$ is the type of random coins for encryption, must be \texttt{bounded}.
...
\item $\texttt{expand IND\_CCA2\_sym\_enc\_r(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r},
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{enc\_seed}$ is the type of random coins for encryption, must be \texttt{bounded}.
...
\item $\texttt{expand INT\_PTXT\_sym\_enc(}\vn{key},
  ...
  ciphertexts of length at most $l'$.
   ...
   $\texttt{int\_ptxt\_partial}(\vn{enc})$, for use in the
   ...
   $\texttt{ind\_ptxt\_partial}(\vn{enc})$ replaces only some of them. 
...
\item $\texttt{expand INT\_PTXT\_sym\_enc\_r(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r},
  \vn{dec}, \vn{injbot}, \ab \vn{Pencptxt}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{enc\_seed}$ is the type of random coins for encryption, must be \texttt{bounded}.
  $\vn{enc\_r}(\vn{cleartext}, \vn{key}, \vn{enc\_seed}): \vn{ciphertext}$ is the encryption function that takes coins as argument (instead of generating them internally).
...
\sloppy
   ...
   $\texttt{int\_ptxt\_partial}(\vn{enc})$ transform only some
   occurrences of encryption and/or decryption.  They can be applied
   only manually, in any order.
   %
...
\item $\texttt{expand IND\_CCA2\_INT\_PTXT\_sym\_enc\_r(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r},
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pencptxt}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{enc\_seed}$ is the type of random coins for encryption, must be \texttt{bounded}.
  $\vn{enc\_r}(\vn{cleartext}, \vn{key}, \vn{enc\_seed}): \vn{ciphertext}$ is the encryption function that takes coins as argument (instead of generating them internally).
...
\item $\texttt{expand SUF\_CMA\_det\_mac(}\vn{mkey},
  ...
  $\vn{mac}(k,m) = m'$.
   ...
   $\vn{mkey}$ is the type of keys, must be \texttt{bounded} (to
...
\item $\texttt{expand UF\_CMA\_proba\_mac\_r(}\vn{mkey},
  \vn{macinput}, \vn{macres}, \vn{mac\_seed}, \vn{mac}, \vn{mac\_r}, \vn{check},
...
\item $\texttt{expand SUF\_CMA\_proba\_mac\_r(}\vn{mkey},
  \vn{macinput}, \vn{macres}, \vn{mac\_seed}, \vn{mac}, \vn{mac\_r}, \vn{check},
  \vn{Pmac}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{mac\_seed}$ is the type of random coins for MAC, must be \texttt{bounded}.
...
\item $\texttt{expand IND\_CCA2\_public\_key\_enc(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{cleartext}, \vn{ciphertext}, \vn{skgen}, \vn{pkgen}, \ab \vn{enc}, \ab
...
\item $\texttt{expand IND\_CCA2\_public\_key\_enc\_r(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{skgen}, \vn{pkgen}, \ab \vn{enc}, \ab \vn{enc\_r}, \ab
  \vn{dec}, \ab \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab\vn{Penccoll}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{enc\_seed}$ is the type of random coins for encryption, must be \texttt{bounded}.
...
\item $\texttt{expand UF\_CMA\_det\_signature(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \vn{skgen}, \vn{pkgen}, \ab \vn{sign}, \ab
...
\item $\texttt{expand UF\_CMA\_proba\_signature\_r(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \vn{sign\_seed}, \vn{skgen}, \ab \vn{pkgen}, \ab \vn{sign}, \ab \vn{sign\_r}, \ab
  \vn{check}, \ab \vn{Psign}, \ab\vn{Psigncoll}\texttt{).}$ is similar to the above,
  with two additional arguments. 
...
\item $\texttt{expand SUF\_CMA\_proba\_signature\_r(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \vn{sign\_seed}, \vn{skgen}, \ab \vn{pkgen}, \ab \vn{sign}, \ab \vn{sign\_r}, \ab
  \vn{check}, \ab \vn{Psign}, \ab\vn{Psigncoll}\texttt{).}$ is similar to the above,
  with two additional arguments. 
  $\vn{sign\_seed}$ is the type of random coins for signature, must be \texttt{bounded}.
...
$\texttt{expand ROM\_hash\_quad(}\vn{key}, \vn{hashinput1}, \vn{hashinput2}, \vn{hashinput3}, \vn{hashinput4}, \vn{hashoutput}, \vn{hash}, \vn{hashoracle}, \vn{qH}\texttt{).}$\\
   define random oracles with 2, 3, and 4 arguments respectively, similarly to \texttt{ROM\_hash} above.
...
\item $\texttt{expand\ square\_CDH(}G, Z, g, \vn{exp}, \vn{mult},
  \vn{pCDH}\texttt{).}$ defines a group that satisfies the square
...
\item $\texttt{expand\ square\_DDH(}G, Z, g, \vn{exp}, \vn{mult},
  \vn{PDDH}\texttt{).}$ defines a group that satisfies the square decisional
...
\item $\texttt{expand AEAD\_from\_Enc\_then\_MAC(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{add\_data}, \vn{enc},
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pmac}\texttt{).}$ defines an
