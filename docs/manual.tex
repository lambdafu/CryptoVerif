...
\item $\texttt{expand AEAD\_nonce\_all\_args(}\vn{key},
  ...
  \vn{dec}, \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pencctxt}\texttt{).}$ is similar to the above with one additional argument.
...
\item $\texttt{expand IND\_CCA2\_sym\_enc\_all\_args(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r}, \vn{enc\_r}',
  \vn{dec}, \vn{dec}', \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}\texttt{).}$ is similar to the above,
...
\item $\texttt{expand INT\_PTXT\_sym\_enc\_all\_args(}\vn{key},
  ...
  \vn{dec}, \vn{dec}', \vn{injbot}, \ab \vn{Pencptxt}\texttt{).}$ is similar to the above,
  with three additional arguments. 
...
\item $\texttt{expand IND\_CCA2\_INT\_PTXT\_sym\_enc\_all\_args(}\vn{key},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \vn{enc}, \vn{enc\_r}, \vn{enc\_r}',
  \vn{dec},  \vn{dec}', \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab \vn{Pencptxt}\texttt{).}$ is similar to the above,
  with four additional arguments. 
...
\item $\texttt{expand UF\_CMA\_proba\_mac\_all\_args(}\vn{mkey},
  ...
  \ab \vn{Pmac}\texttt{).}$ is similar to the above,
  with four additional arguments. 
...
\item $\texttt{expand SUF\_CMA\_proba\_mac\_all\_args(}\vn{mkey},
  \vn{macinput}, \vn{macres}, \vn{mac\_seed}, \vn{mac}, \ab \vn{mac\_r}, \ab \vn{mac\_r}', \ab \vn{check}, \ab
...
\item $\texttt{expand IND\_CCA2\_public\_key\_enc\_all\_args(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{cleartext}, \vn{ciphertext}, \vn{enc\_seed}, \ab \vn{skgen}, \ab \vn{skgen}', \ab \vn{pkgen}, \ab \vn{pkgen}', \ab \vn{enc}, \ab \vn{enc\_r}, \ab \vn{enc\_r}', \ab
  \vn{dec}, \ab \vn{dec}', \ab \vn{injbot}, \ab \vn{Z}, \ab \vn{Penc}, \ab\vn{Penccoll}\texttt{).}$ is similar to the above,
...
\item $\texttt{expand UF\_CMA\_det\_signature\_all\_args(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \vn{skgen}, \ab \vn{skgen}', \ab \vn{pkgen}, \ab \vn{pkgen}', \ab \vn{sign}, \ab \vn{sign}', \ab
  \vn{check}, \ab \vn{check}', \ab \vn{Psign}, \ab\vn{Psigncoll}\texttt{).}$ is similar to the above with four additional arguments.
...
\item $\texttt{expand UF\_CMA\_proba\_signature(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \ab \vn{skgen}, \ab \vn{pkgen}, \ab \vn{sign}, \ab
  \vn{check}, \ab \vn{Psign}, \ab\vn{Psigncoll}\texttt{).}$ defines a
...
\item $\texttt{expand UF\_CMA\_proba\_signature\_all\_args(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \vn{sign\_seed}, \ab \vn{skgen}, \ab \vn{skgen}', \ab \vn{pkgen}, \ab \vn{pkgen}', \ab \vn{sign}, \ab \vn{sign\_r}, \ab \vn{sign\_r}', \ab
  \vn{check}, \ab \vn{check}', \ab \vn{Psign}, \ab\vn{Psigncoll}\texttt{).}$ is similar to the above,
  with six additional arguments. 
...
\item $\texttt{expand SUF\_CMA\_proba\_signature(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \ab \vn{signature}, \ab \vn{skgen}, \ab \vn{pkgen}, \ab \vn{sign}, \ab
  \vn{check}, \ab \vn{Psign}, \ab\vn{Psigncoll}\texttt{).}$ defines a
  SUF-CMA (strongly unforgeable under chosen message attacks)
  probabilistic signature scheme.
  The arguments are the same as for $\texttt{UF\_CMA\_det\_signature}$,
...
\item $\texttt{expand SUF\_CMA\_proba\_signature\_all\_args(}\vn{keyseed}, \vn{pkey}, \vn{skey},
  \vn{signinput}, \vn{signature}, \ab \vn{sign\_seed}, \ab \vn{skgen}, \ab \vn{pkgen}, \ab \vn{sign}, \ab \vn{sign\_r}, \ab
...
\item $\texttt{expand OW\_trapdoor\_perm\_RSR(}\vn{seed}, \vn{pkey}, \vn{skey}, \vn{D}, \vn{pkgen}, \vn{skgen}, \vn{f}, \vn{invf}, \vn{POW}\texttt{).}$ defines a one-way trapdoor permutation, with random self-reducibility. The arguments are the same as above, but the probability of breaking one-wayness is bounded more precisely. This macro defines the equivalences $\texttt{remove\_invf}(f)$ as above and $\texttt{ow\_rsr}(f)$.
...
\item $\texttt{expand\ CDH(}G, Z, g, \vn{exp}, \vn{mult},
  ...
  Diffie-Hellman assumption.
   ...
   $p$: the probability of breaking the considered property, here the CDH assumption, for one pair of
   exponents.
