...
\item $\texttt{after "}\mathit{regexp}\texttt{"}$ designates the program
  point at the beginning of the line that follows the line
...
\item $\texttt{after\_nth }n\texttt{ "}\mathit{regexp}\texttt{"}$
  designates the program point at the beginning of the line that
  follows the $n$-th line that matches the regular expression
  $\mathit{regexp}$.
