...
and the full output of the test is stored in $\texttt{tests/}\nonterm{prefix\_for\_output\_files}\nonterm{date}$, a summary of the results in $\texttt{tests/sum-}\nonterm{prefix\_for\_output\_files}\nonterm{date}$, and a comparison with expected results in $\texttt{tests/res-}\nonterm{prefix\_for\_output\_files}\nonterm{date}$.
