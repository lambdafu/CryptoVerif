...
and pattern =
  | PPatVar of ident_underscore * ty option(*optional type*)
...
type progopt =
  | PWrite of ident (*variable*) * ident (* file *)
...
type decl =
  | FunDecl of ident * ident list(*types*) * ident (*type*) * ident list(* options *)
