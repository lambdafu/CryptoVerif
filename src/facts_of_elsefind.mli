...
(* [get_facts_of_elsefind_facts] uses elsefind facts to derive more facts, 
   ...
   [get_facts_of_elsefind_facts g cur_array simp_facts pps history def_vars]
   ...
   [pps] the program points known to be executed
   [history] the history at the current program point
...
val get_facts_of_elsefind_facts : game -> repl_index list -> simp_facts -> program_points_args list -> known_history option -> binderref list -> term list
